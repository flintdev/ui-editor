// src/containers/Toolbar/StateActionsDialog/ActionsPane/ActionsPane.tsx
...
class ActionsPane extends React.Component<Props, object> {
    state: State = {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(ActionsPane));
