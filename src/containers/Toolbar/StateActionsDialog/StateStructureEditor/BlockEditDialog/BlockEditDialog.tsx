// src/containers/Toolbar/StateActionsDialog/StateStructureEditor/BlockEditDialog/BlockEditDialog.tsx
...
const DataTypes = ["string", "integer", "object", "boolean", "string[]", "integer[]", "$ref", "$ref[]"];
...
const mapDispatchToProps = (dispatch: Dispatch<actions.ToolbarAction>) => {
    return {
        blockEditDialogClose: () => dispatch(actions.blockEditDialogClose()),
    }
};
